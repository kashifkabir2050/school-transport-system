...
import { getFirestore, collection, addDoc, getDocs, updateDoc, deleteDoc, doc, query, where, orderBy } from "https://www.gstatic.com/firebasejs/12.12.1/firebase-firestore.js";
...
export { db, auth, collection, addDoc, getDocs, updateDoc, deleteDoc, doc, query, where, orderBy, signInWithEmailAndPassword, signOut, onAuthStateChanged };
...
export const ALL_GRADES = ["KG1","KG2","G1","G2","G3","G4","G5","G6","G7","G8","G9","G10","G11","G12"];

export const SECTIONS = ["A","B","C","D","E","F","AB","BB","CB","DB","AG","BG","CG","DG"];
